...
public class CreditCardServiceImpl {
    ...
    /**
     * Validate the last digit of the given card number against the Luhn formula.
     *
     * @param number, String represents a credit card number
...
//        }
     ...
     *
     * @param number, String represents a card number
     * @throws CreditCardException
     */
     ...
     *
     * @param date String, represents a credit card date.
     * @throws CreditCardException
     * @throws
     */
